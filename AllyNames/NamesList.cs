    ...
    public class NamesList
    {
        ...
        public static void InitConfig()
        {
            ...
            configBodyIndexes = new ConfigBodyIndex[]
            {
                ...
                new ConfigBodyIndex( "RoboBallRedBuddy",      "Quiet Probe",              "" ,                      "DO YOU LOVE THEM TOO,RED AND LONELY,COLD" ),
                new ConfigBodyIndex( "RoboBallGreenBuddy",    "Delighted Probe",          "" ,                      "YES I LOVE YOU TOO,GREEN AND LONELY,BOLD" ),
